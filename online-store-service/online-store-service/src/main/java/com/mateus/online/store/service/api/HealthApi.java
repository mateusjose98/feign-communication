...
import com.mateus.online.store.service.external.ActuatorHealthResponse;
...
public class HealthApi {
    ...
    public List<HealthResponse> health(){
       ...
       for(BaseClient baseClient : clients){
            ...
            responses.add(new HealthResponse(baseClient.getClass().getInterfaces()[0].getSimpleName(),
                                                health.getStatus()));
       }
       return responses;
    }
